...
THREE.OrbitControls = function ( object, domElement ) {
	...
	// The four arrow keys
	this.keys = { W: 87, A: 65, S: 83, D: 68, LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40, SHIFT: 16, SPACE: 32};
	...
	function handleMouseMovePan( event ) {
		...
		panEnd.set( screen.width/2, event.clientY );
	...
	function handleTouchMovePan( event ) {
		...
		panEnd.set( screen.width/2, event.touches[ 0 ].pageY );
